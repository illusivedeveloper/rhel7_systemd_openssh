...
RUN  yum localinstall http://mirror.centos.org/centos/7/os/x86_64/Packages/openssh-server-7.4p1-21.el7.x86_64.rpm -y && yum install openssh-clients openssh -y
EXPOSE 22
